...
def calculate_mse(predictions, ground_truth):
    """
    Calculates the Mean Squared Error (MSE) between predicted and ground truth values,
    ignoring joints where visibility is 0.
    """
    pred_points = []
    gt_points = []
    ...
    return mean_squared_error(gt_points, pred_points)
...
predictions = run_model(target_path)
